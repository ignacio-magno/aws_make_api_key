...
require (
	...
	github.com/ignacioMagno/database v0.0.0-20230108055917-954c62e4af80 // indirect
	github.com/ignacioMagno/utils v0.0.0-20221019203746-9fe483ad5d72 // indirect
